...
uint16 varResistorMeasurement = 0;  /* 가변 저항 변수 선언, 초기화 */
uint16 lightSensorMeasurement = 0;  /* 조도 센서 변수 선언, 초기화 */
...
void core0_task_10ms(void)
{
    lightSensorMeasurement = readADCValue(0);   /* 0  */
    varResistorMeasurement = readADCValue(1);   /* 1 */
}
