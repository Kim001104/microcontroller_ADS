...
void stm0Sr0ISR(void)
{
    ...
    taskCounter++;
    /* if 1ms interrupt is occured task1msFlag is gonna be 0000001*/
    if((taskCounter % 1) == 0U)
    {
        task1msFlag = 1U;
    }
    /* if 10ms interrupt is occured task10msFlag is gonna be 00000001 */
    if((taskCounter % 10) == 0U)
    {
        task10msFlag = 1U;
    }

    /* if 100ms interrupt is occured task100msFlag is gonna be 00000001 */
